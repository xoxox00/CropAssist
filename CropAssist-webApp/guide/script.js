...
function showCrop(crop) {
  ...
  if (crop === "chilli") {
    content = `
            <h2>Chilli Cultivation</h2>
            <h3>1. Introduction</h3>
            <p>Overview of Chilli: Chilli (Capsicum annuum) is a vital spice crop grown in South India for its pungent fruit, used in cuisines worldwide. This guide covers the complete cultivation process.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Seeds:</strong> High-quality, disease-resistant chilli seeds.</li>
                <li><strong>Fertilizers:</strong> Balanced NPK fertilizers and organic manure.</li>
                <li><strong>Irrigation System:</strong> Drip irrigation is highly recommended.</li>
                <li><strong>Pest Control:</strong> Fungicides and pesticides for common pests like thrips and fruit borers.</li>
                <li><strong>Tools:</strong> Nursery trays, hand tools for transplanting and weeding.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Chilli thrives in well-drained, loamy soil with a pH of 6.5 to 7.5. The field should be plowed 2-3 times to achieve a fine tilth.</p>
            
            <h4>Seed Selection and Treatment:</h4>
            <p>Select high-yielding hybrid varieties. Treat seeds with fungicides to prevent seed-borne diseases.</p>
            
            <h4>Field Preparation:</h4>
            <p>Prepare raised beds for planting to ensure proper drainage and root development.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Chilli is grown in multiple seasons; Kharif (June-July), Rabi (Sept-Oct), and Summer (Jan-Feb).</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Transplant seedlings at a spacing of 60x45 cm. Plant seedlings about 2-3 cm deep.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Raise seedlings in a nursery for 30-40 days before transplanting to the main field.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Requires regular watering, especially during flowering and fruit development. Drip irrigation is efficient.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply a basal dose of NPK and manure at planting. Top-dress with nitrogen at 30, 60, and 90 days after transplanting.</p>
            
            <h4>Weed Control:</h4>
            <p>Perform manual weeding or use pre-emergence herbicides to keep the field weed-free, especially in the first 45 days.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Manage pests like thrips, aphids, and fruit borers with appropriate insecticides. Control diseases like powdery mildew and leaf curl with fungicides.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Vegetative Stage:</h4>
            <p>Ensure proper nutrient and water supply for robust plant growth.</p>
            
            <h4>Flowering and Fruiting:</h4>
            <p>Avoid water stress during this critical stage to prevent flower drop and ensure good fruit set.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvesting begins 75-90 days after transplanting. Green chillies can be picked as needed. For dry chillies, wait until they turn fully red.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>Hand-pick the fruits carefully to avoid damaging the plant.</p>
            
            <h4>Post-Harvest Handling:</h4>
            <p>For dry chillies, sun-dry the harvested red fruits for 7-10 days until they are crisp.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Storage Conditions:</h4>
            <p>Store dry chillies in cool, dry, and well-ventilated gunny bags to prevent mold.</p>
            
            <h4>Processing:</h4>
            <p>Chillies can be ground into powder after drying.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Leaf curl virus, fruit rot, and pest infestations (thrips).</p>
            
            <h4>Solutions:</h4>
            <p>Use virus-resistant varieties, practice crop rotation, and implement a timely pest management schedule.</p>
        `;
  }
  ...
  if (crop === "sugarcane") {
    content = `
            ...
            <h3>1. Introduction</h3>
            <p>Overview of Sugarcane: Sugarcane (Saccharum officinarum) is a major cash crop in South India, grown for its sucrose-rich stalks. It is the primary source of sugar and jaggery.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Setts:</strong> Healthy, disease-free seed cane pieces (setts) with 2-3 buds.</li>
                <li><strong>Fertilizers:</strong> High requirement of NPK, especially Nitrogen and Potassium.</li>
                <li><strong>Irrigation System:</strong> Furrow or drip irrigation is essential.</li>
                <li><strong>Pest Control:</strong> Management for pests like early shoot borer and termites.</li>
                <li><strong>Tools:</strong> Heavy machinery for plowing, hand tools for planting and de-trashing.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Grows in a variety of soils but thrives in well-drained loam to clay-loam with a pH of 6.5 to 7.5. Deep plowing is required.</p>
            
            <h4>Sett Selection and Treatment:</h4>
            <p>Select setts from a healthy, 8-10 month old nursery crop. Treat setts with fungicide solution before planting.</p>
            
            <h4>Field Preparation:</h4>
            <p>Create deep furrows for planting, typically 90-120 cm apart.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Can be planted in December-February (Adsali) or June-August (Eksali).</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Place setts end-to-end in furrows and cover with 5-7 cm of soil.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Manual planting of setts in furrows is the most common method.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Sugarcane is a water-intensive crop, requiring frequent irrigation, especially during the formative and grand growth stages.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply NPK fertilizers in split doses. A large portion of nitrogen is applied during the tillering stage.</p>
            
            <h4>Weed Control:</h4>
            <p>Weed control through manual weeding or herbicides is crucial in the first 3-4 months.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Manage early shoot borer and internode borer with biological or chemical controls. Red rot is a major disease to watch for.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Tillering Stage:</h4>
            <p>Earthing up (piling soil around the base) is done to support the plant and encourage root growth.</p>
            
            <h4>Grand Growth Stage:</h4>
            <p>De-trashing (removing dry lower leaves) and propping (tying canes together) helps prevent lodging.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvesting is done 12-18 months after planting, when the lower leaves dry up and canes produce a metallic sound when tapped.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>Canes are cut at ground level using heavy knives.</p>
            
            <h4>Post-Harvest Handling:</h4>
            <p>Harvested cane should be transported to the sugar mill within 24 hours to prevent sucrose loss.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Ratooning:</h4>
            <p>After harvesting, the remaining stubble can be managed to grow a new crop (ratoon crop), which matures earlier.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Water scarcity, lodging, pest and disease outbreaks (Red Rot).</p>
            
            <h4>Solutions:</h4>
            <p>Adopt drip irrigation, use lodging-resistant varieties, and practice integrated pest and disease management.</p>
        `;
  }
  ...
  if (crop === "turmeric") {
    content = `
            ...
            <h3>1. Introduction</h3>
            <p>Overview of Turmeric: Turmeric (Curcuma longa) is a rhizomatous spice crop grown for its bright yellow rhizomes, which are used in cooking, medicine, and dyeing.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Rhizomes:</strong> Healthy mother or finger rhizomes for planting.</li>
                <li><strong>Fertilizers:</strong> Farm Yard Manure (FYM), NPK fertilizers.</li>
                <li><strong>Mulching Material:</strong> Green leaves or straw for mulching.</li>
                <li><strong>Pest Control:</strong> Management for shoot borer and rhizome scale.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Thrives in well-drained, sandy or clay loam soils with a pH of 5.0 to 7.5. The land should be prepared to a fine tilth by plowing 3-4 times.</p>
            
            <h4>Rhizome Selection and Treatment:</h4>
            <p>Select healthy, disease-free rhizomes. Treat with fungicide before planting to prevent rot.</p>
            
            <h4>Field Preparation:</h4>
            <p>Prepare raised beds of 1 meter width and 15 cm height.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Planting is done with the onset of the monsoon, typically in May-June.</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Plant rhizomes in small pits on the raised beds at a spacing of 25x30 cm and a depth of 5 cm.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Manual planting of rhizomes is the standard practice.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Turmeric requires regular moisture. Irrigate every 7-10 days depending on soil type and climate.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply a heavy basal dose of FYM. NPK fertilizers are applied in split doses.</p>
            
            <h4>Weed Control and Mulching:</h4>
            <p>The crop is mulched immediately after planting with green leaves or straw. This conserves moisture, controls weeds, and adds organic matter. Weeding is done 2-3 times.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Manage shoot borer and rhizome scale with appropriate insecticides. Leaf spot and rhizome rot are major diseases.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Rhizome Development:</h4>
            <p>Earthing up should be done twice during the growth period to cover the developing rhizomes and support the plant.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>The crop is ready for harvest in 7-9 months when the leaves and stem turn yellow and dry up.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>The land is plowed and the rhizomes are carefully dug up by hand.</p>
            
            <h4>Post-Harvest Handling:</h4>
            <p>Harvested rhizomes are cleaned of mud and roots.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Curing and Polishing:</h4>
            <p>Rhizomes are boiled until soft, then sun-dried for 10-15 days. Dried turmeric is polished to give it a better appearance.</p>
            
            <h4>Storage:</h4>
            <p>Store cured turmeric in a cool, dry place. Seed rhizomes are stored in well-ventilated pits.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Rhizome rot disease, low productivity due to poor quality planting material.</p>
            
            <h4>Solutions:</h4>
            <p>Ensure good drainage, treat seed rhizomes, and use high-yielding varieties.</p>
        `;
  }

  if (crop === "ragi") {
    content = `
            <h2>Ragi (Finger Millet) Cultivation</h2>
            <h3>1. Introduction</h3>
            <p>Overview of Ragi: Ragi or Finger Millet (Eleusine coracana) is a hardy, nutritious cereal crop grown extensively in the dryland regions of South India. It is valued for its high calcium and iron content.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Seeds:</strong> High-quality seeds of improved varieties.</li>
                <li><strong>Fertilizers:</strong> Moderate requirement of NPK and organic manure.</li>
                <li><strong>Irrigation:</strong> Mostly grown as a rainfed crop, but supplementary irrigation helps.</li>
                <li><strong>Tools:</strong> Hand tools for weeding, sickles for harvesting.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Ragi can grow in a variety of soils but prefers well-drained red loams with a pH of 5.5 to 7.5. The field should be plowed 2-3 times.</p>
            
            <h4>Seed Selection and Treatment:</h4>
            <p>Use certified seeds. Treat seeds with fungicide to protect against blast disease.</p>
            
            <h4>Field Preparation:</h4>
            <p>A well-leveled, clean seedbed is required for direct sowing or transplanting.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Typically sown during the Kharif season (June-July) with the onset of the monsoon.</p>
            
            <h4>Spacing and Depth:</h4>
            <p>For direct sowing, use a row spacing of 22.5-30 cm. For transplanting, space seedlings at 25x10 cm. Sow seeds 2-3 cm deep.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Can be directly sown (broadcasting or line sowing) or transplanted from a nursery after 20-25 days.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>It's a drought-tolerant crop. One or two irrigations are beneficial during long dry spells, especially at flowering.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply half the nitrogen and full phosphorus and potassium as a basal dose. The remaining nitrogen is applied 3-4 weeks after sowing.</p>
            
            <h4>Weed Control:</h4>
            <p>Weeding is essential in the early stages (up to 35 days). Two manual weedings are usually sufficient.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>The major disease is blast. Pests like stem borer and aphids can sometimes be an issue. Use resistant varieties and need-based pesticides.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Tillering:</h4>
            <p>Ensure the field is weed-free to promote healthy tiller development.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>The crop matures in 3-4 months. Harvest when the earheads turn brownish.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>Harvesting is done by cutting the earheads first, followed by the straw a few days later. Sickles are used for this purpose.</p>
            
            <h4>Post-Harvest Handling:</h4>
            <p>The harvested earheads are dried in the sun for 2-3 days.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Threshing and Storage:</h4>
            <p>Grains are separated from the earheads by threshing. Ragi grains can be stored for several years without insect damage if kept dry.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Blast disease, bird damage, and weed infestation.</p>
            
            <h4>Solutions:</h4>
            <p>Use blast-resistant varieties, manage weeds in the early stages, and employ bird-scaring methods during grain filling.</p>
        `;
  }

if (crop === "groundnut") {
    content = `
            <h2>Groundnut (Peanut) Cultivation</h2>
            <h3>1. Introduction</h3>
            <p>Overview of Groundnut: Groundnut (Arachis hypogaea) is a major oilseed and legume crop in South India. It is grown for its edible seeds, which are rich in oil and protein.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Seeds:</strong> High-quality, bold seeds of suitable varieties.</li>
                <li><strong>Fertilizers:</strong> NPK, gypsum, and zinc sulphate.</li>
                <li><strong>Inoculant:</strong> Rhizobium culture for nitrogen fixation.</li>
                <li><strong>Irrigation:</strong> Sprinkler or drip irrigation for summer crops.</li>
                <li><strong>Pest Control:</strong> Management for leaf spot (Tikka) disease and pests like leaf miner.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Thrives in well-drained, sandy loam soil with a pH of 6.0 to 6.5. The soil should be loose and friable to allow for easy peg penetration.</p>
            
            <h4>Seed Selection and Treatment:</h4>
            <p>Use kernels from freshly shelled pods. Treat seeds with fungicide and Rhizobium culture.</p>
            
            <h4>Field Preparation:</h4>
            <p>Prepare the field to a fine tilth and form beds and channels for irrigation.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Sown in Kharif (June-July) as a rainfed crop and in Rabi/Summer (Nov-Jan) with irrigation.</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Sow seeds at a spacing of 30x10 cm and a depth of 5 cm.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Dibbling seeds behind the plough or using a seed drill are common methods.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Critical stages for irrigation are flowering, pegging, and pod development. The rainfed crop may require protective irrigation during dry spells.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply NPK as a basal dose. Application of gypsum at the flowering stage is crucial for pod development.</p>
            
            <h4>Weed Control:</h4>
            <p>Weed control is vital for the first 45 days. Hand weeding and application of pre-emergence herbicides are common.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Control leaf spot (Tikka) disease with fungicides. Manage pests like leaf miner and aphids with appropriate insecticides.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Pegging Stage:</h4>
            <p>Ensure loose soil surface and adequate moisture for pegs to penetrate the soil. Earthing up can be beneficial.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvest when the leaves turn yellow and start shedding, and the inner shell of the pod turns dark. This is typically 100-130 days after sowing.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>The plants are pulled up by hand or using a tractor-drawn harvester. The pulled plants are stacked for a few days to cure.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Stripping and Drying:</h4>
            <p>Pods are separated from the plants (stripping) and then sun-dried for 4-5 days to reduce moisture content below 10%.</p>
            
            <h4>Storage:</h4>
            <p>Store dried pods in gunny bags in a cool, dry place.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Leaf spot disease, aflatoxin contamination in pods, and damage by wild boars.</p>
            
            <h4>Solutions:</h4>
            <p>Use disease-resistant varieties, dry pods properly to avoid aflatoxin, and fence the fields to protect from animals.</p>
        `;
  }

  if (crop === "sorghum") {
    content = `
            <h2>Sorghum (Jowar) Cultivation</h2>
            <h3>1. Introduction</h3>
            <p>Overview of Sorghum: Sorghum or Jowar (Sorghum bicolor) is a staple food grain and fodder crop in the semi-arid regions of South India. It is highly drought-tolerant.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Seeds:</strong> High-quality seeds of hybrid or improved varieties.</li>
                <li><strong>Fertilizers:</strong> Moderate requirement of NPK fertilizers.</li>
                <li><strong>Irrigation:</strong> Mostly grown rainfed; protective irrigation is beneficial.</li>
                <li><strong>Pest Control:</strong> Management for shoot fly and stem borer.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Can be grown on a wide range of soils but performs best in clay loam soils with good drainage. The field should be plowed to get a good tilth.</p>
            
            <h4>Seed Selection and Treatment:</h4>
            <p>Use certified seeds. Treat seeds with fungicide to control seed-borne diseases.</p>
            
            <h4>Field Preparation:</h4>
            <p>A well-prepared seedbed ensures good germination and crop stand.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Sown in Kharif (June-July) and Rabi (September-October) seasons.</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Use a row spacing of 45 cm and a plant-to-plant spacing of 15 cm. Sow seeds at a depth of 3-4 cm.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Line sowing using a seed drill is the recommended method.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Being drought-tolerant, it requires less water. However, irrigation at critical stages like flowering and grain filling improves yield significantly.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply half the nitrogen and full phosphorus and potassium as basal. Apply the remaining nitrogen 30-35 days after sowing.</p>
            
            <h4>Weed Control:</h4>
            <p>Two hand weedings at 20 and 40 days after sowing are effective. Herbicides can also be used.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Shoot fly and stem borer are major pests. Manage them by timely sowing and insecticide application. Grain mold is a major disease in the Kharif season.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Grain Filling:</h4>
            <p>Protect the crop from birds during this stage by using bird scarers.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvest when the grains are hard and contain less than 20% moisture, typically 100-120 days after sowing.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>Cut the earheads separately from the stalks. The stalks (fodder) are cut later.</p>
            ...
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Threshing and Storage:</h4>
            <p>Grains are separated by threshing the dried earheads. The grains should be dried again to below 12% moisture before storage.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Shoot fly and stem borer infestation, grain mold in humid conditions, and bird damage.</p>
            
            <h4>Solutions:</h4>
            <p>Adhere to the recommended sowing time, use resistant varieties, and protect the crop from birds.</p>
        `;
  }

  if (crop === "tapioca") {
    content = `
            <h2>Tapioca (Cassava) Cultivation</h2>
            <h3>1. Introduction</h3>
            <p>Overview of Tapioca: Tapioca or Cassava (Manihot esculenta) is a major tuber crop grown in South India, especially Kerala and Tamil Nadu. It's a key source of carbohydrates and industrial starch.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Setts:</strong> Healthy stem cuttings (setts) of 15-20 cm length.</li>
                <li><strong>Fertilizers:</strong> Requires heavy application of Potassium, along with Nitrogen and Phosphorus.</li>
                <li><strong>Irrigation:</strong> Requires irrigation during dry periods.</li>
                <li><strong>Pest Control:</strong> Management for pests like spider mites and cassava mosaic disease.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Grows best in well-drained loamy soils with a pH of 5.5 to 6.5. The land should be plowed deep to facilitate tuber development.</p>
            
            <h4>Sett Selection and Treatment:</h4>
            <p>Select setts from mature, disease-free plants. The bottom two-thirds of the stem are best. Dip setts in fungicide before planting.</p>
            
            <h4>Field Preparation:</h4>
            <p>Mounds or ridges are prepared for planting to ensure good drainage and space for tuber growth.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Can be planted year-round, but April-May is the ideal time with the onset of pre-monsoon showers.</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Plant setts on mounds or ridges at a spacing of 90x90 cm. Plant them vertically with two-thirds of their length inside the soil.</p>
            
            <h4>Seeding Methods:</h4>
            <p>Manual planting of stem cuttings is the only method.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Though drought-tolerant, it responds well to irrigation, especially during the first 3-4 months. Avoid waterlogging.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply NPK fertilizers in split doses. A full dose of phosphorus and half doses of nitrogen and potassium are applied as basal. The remaining N and K are applied 2-3 months after planting.</p>
            
            <h4>Weed Control:</h4>
            <p>Keep the field weed-free for the first 3-4 months through hand weeding and earthing up.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Cassava Mosaic Disease (CMD) is a major constraint; use resistant varieties. Spider mites can be a problem in dry weather.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Tuber Bulking:</h4>
            <p>Ensure adequate potassium and moisture during this stage. Earthing up helps in better tuber development.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvesting is done 8-10 months after planting when the leaves turn yellow and start to fall.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>The stems are cut leaving about 15 cm above ground. The tubers are then carefully dug out by hand or with the help of a crowbar.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Storage:</h4>
            <p>Tapioca tubers are highly perishable and should be consumed or processed within 2-3 days of harvest.</p>
            
            <h4>Processing:</h4>
            <p>Tubers are processed into chips, flour, and starch (sago).</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Cassava Mosaic Disease, short shelf-life of tubers, and price fluctuation.</p>
            
            <h4>Solutions:</h4>
            <p>Use CMD-resistant varieties, process the tubers immediately after harvest, and explore value-addition to get better returns.</p>
        `;
  }
  ...
  if (crop === "blackpepper") {
    content = `
            ...
            <h3>1. Introduction</h3>
            <p>Overview of Black Pepper: Black Pepper (Piper nigrum), the "King of Spices," is a perennial vine grown for its berries. It is cultivated extensively in the Western Ghats region of South India.</p>
            
            <h3>2. Materials and Resources Required</h3>
            <ul>
                <li><strong>Cuttings:</strong> Rooted cuttings from high-yielding, healthy mother vines.</li>
                <li><strong>Support Trees:</strong> Live standards (support trees) like Erythrina or dead standards like concrete posts.</li>
                <li><strong>Fertilizers:</strong> Organic manure and NPK fertilizers.</li>
                <li><strong>Irrigation:</strong> Drip irrigation is beneficial during summer.</li>
                <li><strong>Pest Control:</strong> Management for pests like Pollu beetle and diseases like quick wilt.</li>
            </ul>
            
            <h3>3. Preparation Steps</h3>
            <h4>Soil Preparation:</h4>
            <p>Requires well-drained, humus-rich soil with a pH of 5.5 to 6.5. It is grown on hill slopes.</p>
            
            <h4>Support (Standard) Preparation:</h4>
            <p>Plant support trees one year ahead of planting pepper vines. Pits are dug near the base of the support.</p>
            
            <h3>4. Planting Procedure</h3>
            <h4>Planting Time:</h4>
            <p>Planting is done during the monsoon season (June-July).</p>
            
            <h4>Spacing and Depth:</h4>
            <p>Plant 2-3 rooted cuttings in pits of 50x50x50 cm at the base of each support. The pits are spaced at 3x3 meters.</p>
            
            <h4>Planting Method:</h4>
            <p>The cuttings are planted and tied to the support. The pit is filled with topsoil and compost.</p>
            
            <h3>5. Growth Stages and Care</h3>
            <h4>Watering Requirements:</h4>
            <p>Irrigation is crucial during the summer months to ensure good berry development and prevent spike shedding.</p>
            
            <h4>Nutrient Management:</h4>
            <p>Apply organic manure before the monsoon and NPK fertilizers in two split doses during the rainy season.</p>
            
            <h4>Training and Pruning:</h4>
            <p>The vines are trained to grow on the support. Pruning is done to regulate shade from the support trees and to shape the vine.</p>
            
            <h4>Pest and Disease Management:</h4>
            <p>Quick wilt (foot rot) is a devastating disease; ensure good drainage and apply fungicides. Pollu beetle damages the berries.</p>
            
            <h3>6. Special Care During Growth Stages</h3>
            <h4>Spike Development:</h4>
            <p>Ensure adequate moisture and nutrition during this phase to prevent spike shedding and ensure proper berry setting.</p>
            
            <h3>7. Harvesting Process</h3>
            <h4>Optimal Harvest Time:</h4>
            <p>Harvesting begins from the 3rd year. It is done from November to February when one or two berries in the spike turn from green to bright orange.</p>
            
            <h4>Harvesting Techniques:</h4>
            <p>Entire spikes are hand-picked from the vine.</p>
            
            <h4>Post-Harvest Handling:</h4>
            <p>The harvested spikes are kept for a day before the berries are separated.</p>
            
            <h3>8. Post-Harvest Management and Storage</h3>
            <h4>Drying and Processing:</h4>
            <p>The separated berries are sun-dried for 7-10 days until the skin becomes black and wrinkled. This gives black pepper. For white pepper, the outer skin is removed before drying.</p>
            
            <h4>Storage:</h4>
            <p>Store dried pepper in clean gunny bags in a dry place.</p>
            
            <h3>9. Challenges and Solutions</h3>
            <h4>Challenges:</h4>
            <p>Quick wilt disease, spike shedding, and price volatility.</p>
            
            <h4>Solutions:</h4>
            <p>Adopt integrated disease management, ensure irrigation in summer, and explore market options like organic and fair-trade certification.</p>
        `;
  }

  // ... (All other existing 'if' blocks for maize, jute, coffee etc. are included below)
